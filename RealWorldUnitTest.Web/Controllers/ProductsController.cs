...
namespace RealWorldUnitTest.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Stok,Color")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int id, [Bind("Id,Name,Price,Stok,Color")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
